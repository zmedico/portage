...
class MergeOrderTestCase(TestCase):
    def testMergeOrder(self):
        ...
        test_cases = (
            ...
            ResolverPlaygroundTestCase(
                [
                    "app-misc/circ-satisfied-a",
                    "app-misc/circ-satisfied-b",
            ...
            ResolverPlaygroundTestCase(
                [
                    "app-misc/circ-smallest-a",
                    "app-misc/circ-smallest-c",
                ...
                all_permutations=True,
                mergelist=[
                    ("app-misc/circ-smallest-a-1", "app-misc/circ-smallest-b-1"),
                    (
                        "app-misc/circ-smallest-c-1",
                        "app-misc/circ-smallest-d-1",
                        "app-misc/circ-smallest-e-1",
            ...
            ResolverPlaygroundTestCase(
                ...
                ambiguous_merge_order=True,
                mergelist=[
                    ("app-misc/blocker-runtime-a-1", "app-misc/blocker-runtime-b-1"),
            ...
            ResolverPlaygroundTestCase(
                [
                    "app-misc/circ-buildtime-slot-op-new-slot-a",
                    "app-misc/circ-buildtime-slot-op-new-slot-b:2",
                ],
                success=True,
                all_permutations=True,
