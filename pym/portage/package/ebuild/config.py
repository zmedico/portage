...
from portage.dep import Atom, check_required_use, isvalidatom, match_from_list, use_reduce, _repo_separator, _slot_separator
...
class config(object):
	...
	def setcpv(self, mycpv, use_cache=None, mydb=None):
		...
		self.required_use = check_required_use(required_use or '',
			use, lambda k: True)
